...
# def find_1(a,b,c,d,e,f,g,h,i,j,k):
#     cmp = compare_strict_or_reflexive(ai < bi)
#     if cmp(a, b, r): return find_2(c,d,e,f,g,h,i,j,k,a,b)
#     return find_2(c,d,e,f,g,h,i,j,k,b,a)
...
def process(n,i,cost,comps,fn_name,fn_args,var1,var2,if_part,else_part, functions_aliases):
    ...
    code  = f'# {fn_name} ******************* \n'
    code += f'def {new_func_name}({stability_indices}{parameters}r):\n'
