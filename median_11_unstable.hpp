...
auto&& select_2_6_ac_bc_ef(A&& a, B&& b, C&& c, D&& d, E&& e, F&& f, R r) noexcept {
    if ( ! r(e, d)) {
...
auto&& select_3_7_ab_ef_dg_ad_cd_eb(A&& a, B&& b, C&& c, D&& d, E&& e, F&& f, G&& g, R r) noexcept {
    if ( ! r(d, b)) {
        ...
        // }
        return select_2_4_ab(std::forward<A>(a), std::forward<B>(b), std::forward<C>(c), std::forward<F>(f), r);
    } else {
        if ( ! r(f, d)) {
...
auto&&  select_3_6_cd_da_bf_be(A&& a, B&& b, C&& c, D&& d, E&& e, F&& f, R r) noexcept {
    if ( ! r(e, a)) {
        ...
        // }
        return select_2_4_ab(std::forward<C>(c), std::forward<D>(d), std::forward<E>(e), std::forward<F>(f), r);
    }
}
...
auto&&  select_3_6_cd_da_fb_fe(A&& a, B&& b, C&& c, D&& d, E&& e, F&& f, R r) noexcept {
    if ( ! r(b, a)) {
        ...
        // }
        return select_2_4_ab(std::forward<C>(c), std::forward<D>(d), std::forward<B>(b), std::forward<E>(e), r);
    }
}
...
auto&& select_4_7_ab_de_eb_af_cf(A&& a, B&& b, C&& c, D&& d, E&& e, F&& f, G&& g, R r) noexcept {
    if ( ! r(f, b)) {
        if ( ! r(c, a)) {
            ...
            // }
            return select_2_4_ab(std::forward<E>(e), std::forward<B>(b), std::forward<C>(c), std::forward<G>(g), r);
        } else {
            if ( ! r(e, a)) {
...
auto&& select_3_7_cd_ef_df_da_eb(A&& a, B&& b, C&& c, D&& d, E&& e, F&& f, G&& g, R r) noexcept {
    if ( ! r(b, a)) {
        if ( ! r(f, a)) {
            ...
            // }
            return select_2_4_ab(std::forward<D>(d), std::forward<A>(a), std::forward<E>(e), std::forward<G>(g), r);
        } else {
            if ( ! r(e, d)) {
...
auto&& select_3_8_bc_fg_ac_dg_da_eh_be_af(A&& a, B&& b, C&& c, D&& d, E&& e, F&& f, G&& g, H&& h, R r) noexcept {
    if (!r(h, a)) {
        ...
        return select_2_6_ac_bc_ef(std::forward<A>(a), std::forward<B>(b), std::forward<C>(c), std::forward<E>(e), std::forward<F>(f), std::forward<G>(g),r);
    } else {
